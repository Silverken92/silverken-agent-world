...
const CATALOG = {
  en: {
    ...
    copyPath: 'Copy path',
    openProjectOperator: 'Open project in Operator',
    managedWorkspace: 'Managed workspace',
    workspaceRepository: 'Repository',
    workspaceBranch: 'Branch',
    workspaceGitState: 'Git state',
    workspaceClean: 'Clean',
    workspaceModified: 'Modified',
    workspaceUnknown: 'Unknown',
    workspaceValid: 'Valid',
    workspaceCheckRequired: 'Check required',
    settings: 'Settings',
    open: 'Open',
    viewed: 'Viewed',
    archive: 'Archive',
  ...
  fr: {
    ...
    openProjectOperator: 'Ouvrir le projet dans Operator',
    managedWorkspace: 'Workspace géré',
    workspaceRepository: 'Dépôt',
    workspaceBranch: 'Branche',
    workspaceGitState: 'État Git',
    workspaceClean: 'Propre',
    workspaceModified: 'Modifié',
    workspaceUnknown: 'Inconnu',
    workspaceValid: 'Valide',
    workspaceCheckRequired: 'À vérifier',
    settings: 'Paramètres',
    open: 'Ouvrir',
    viewed: 'Vu',
    archive: 'Archiver',
