...
function applyBrand(root = document) {
  ...
  replaceButtonText(root.querySelector('#btn-operator-project'), t('openProjectOperator', currentLocale))
  ...
  setTitle(root, '#btn-operator-project', 'Open this project overview in Agency Agent Operator', 'Ouvrir la vue d’ensemble de ce projet dans Agency Agent Operator')
